...
class HomeViewModel : ViewModel() {
    ...
    fun setList() {
        ...
        val scheduleDto = ScheduleDto(id = 0, group = "IS-1701K",
                mondayList = lessonListVersion1, thurthdayList = lessonListVersion2, tuesdayList = lessonListVersion1,
                fridayList = lessonListVersion1, wednesdayList = lessonListVersion2)
